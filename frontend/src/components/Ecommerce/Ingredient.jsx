...
const IngredientDetail = () => {
  ...
  const [ingdetails, setingDetails] = useState([]);  const navigate = useNavigate();
  ...
  return (<>
   ...
   <br />
    ...
    <div class="banner flex inner">
        <div class="right">
        <img src={ingredient.image} alt="" srcSet="" /><div className="mask">
        ...
        <button type="button" class="btn btn-primary p-3" key={ingredient._id} onClick={() => handleClick(ingredient)}>Buy Now</button>
        <input
                type="number"
...
<h5  className="card-title fontdesg"color='black'><b>Pack Name:</b> {ingredient.packName}</h5>


<hr />

<h5  className="card-title fontdesg"color='black'><b>Recpie Name:</b> {ingredient.recipeName}</h5>
<hr />
...
<b>Avilable Quantity: </b>                          
         <span> {ingredient.totalProducts}</span>
                ...
                <div className="d-flex justify-content-between"> 
                <b>Discount</b>
                  <span> <strong>{ingredient.discount}%</strong></span>
                </div>
              </div>
<p className="card-text">
 
  <br /> <b><i class="fa fa-user" aria-hidden="true"></i></b> {ingredient.seller}&nbsp;&nbsp;&nbsp;&nbsp; 
</p>
<span class="badge bg-success">Price <b><h4>{ingredient.totalPrice}/-</h4></b> </span>
...
<div className="d-flex justify-content-between">
<b><b>Ingredient :</b> {nestedIngredient.name}</b>                          
         <span> <b>Quantity (G):</b> {nestedIngredient.quantity}</span>
