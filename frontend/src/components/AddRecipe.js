...
required
/>
{errors.ingredients && <div class="invalid-feedback">{errors.ingredients}</div>}
</div>
...
required
/>
{errors.instructions && <div class="invalid-feedback">{errors.instructions}</div>}
</div>
          <div class="form-group">
            ...
            <input
              ...
              required
            />
            {errors.timeToCook && <div class="invalid-feedback">{errors.timeToCook}</div>}
          </div>
          ...
          <div class="form-group">
            ...
            />
            {errors.image && <div class="invalid-feedback">{errors.image}</div>}
          </div>
          {image && (
            <div>
              <img
